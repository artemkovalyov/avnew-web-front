; (function () {
	...
	var navigation = function() {
		...
		$('body').on('click', '#gtco-offcanvas ul a:not([class="external"]), .main-nav a:not([class="external"]), .slider-text-inner p a', function(event){
...
function postToGoogle() {
   ...
   $.ajax({
     url: "https://docs.google.com/forms/d/e/1FAIpQLSfqno1_BYxgSMzC-ErE7-1J4jbLhBP1_hbZ0W8vC-DcURo-og/formResponse",
     data: {
       "entry.534377520": field2,
       "entry.402639051": field1,
			 "entry.1459526962": field3
     },
     type: "POST",
     dataType: "xml",
     statusCode: {
